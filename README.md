...
> 약 4주의 간격으로 v1, v2, 최종 v3을 완성하였으며, v1은 release/v1.0.0, v2는 release/v2.0.0, 최종 v3은 현재 dev 브랜치에서 관리하고 있습니다.  
...
- **롱폴링 -> WebSocket 기반 그룹채팅 및 익명채팅**
- ~~**실시간 알림 기능** (입금 확인, 마감 안내 등)~~ ✅ 구현 완료
- ~~**챗봇** (만능 서비스 가이드)~~ ✅ 구현 완료
- **장바구니 기능**
- ~~**관심 목록(찜)** 기능~~ ✅ 구현 완료
- **CI 구성 + 테스트 코드 도입 예정**
